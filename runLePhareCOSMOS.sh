...
echo "Estimation"
$LEPHAREDIR/source/zphota -c eric.para -CAT_IN "$CAT_FILE_IN"  -CAT_OUT zphot_vista_adapt_fors2_SL_normed.out -ZPHOTLIB FORS2_SCOSMOS_SL_NORM,ALLSTAR_SCOSMOS_LR,QSO_SCOSMOS_LR  -ADD_EMLINES 0,30 -AUTO_ADAPT YES  -EM_DISPERSION 50,5 -INP_TYPE F
