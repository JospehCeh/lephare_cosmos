...
$LEPHAREDIR/source/zphota -c COSMOS2020_EmuLP.para -CAT_IN "$CAT_FILE_IN" -CAT_OUT zphot2020_fors2SL_KinCalClusV6_EmuLP_prevEtCal.out -ZPHOTLIB LIB2020_FORS2_SL_KinCalV6_EmuLP_CALetPREV,ALLSTAR_COSMOS2020_EmuLP,ALLQSO_COSMOS2020_EmuLP -ADD_EMLINES 1,29 -AUTO_ADAPT YES -EM_DISPERSION 50,5 -INP_TYPE F
