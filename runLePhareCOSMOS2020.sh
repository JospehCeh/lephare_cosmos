...
$LEPHAREDIR/source/sedtolib -c COSMOS2020.para -t G -GAL_SED ${LEPHAREWORK}/FORS2_forFixedZ_CWW-E_v1.list -GAL_LIB LIB2020_FORS2_forFixedZ_CWW-E_v1
#$LEPHAREDIR/source/mag_gal  -c COSMOS2020.para -t G -GAL_LIB_IN LIB2020_FORS2_forFixedZ_CWW-E_v1 -GAL_LIB_OUT LIB2020_FORS2_forFixedZ_CWW-E_v1_CALetPREV -MOD_EXTINC 0,29,0,29 -EXTINC_LAW SB_calzetti.dat,SMC_prevot.dat
$LEPHAREDIR/source/mag_gal  -c COSMOS2020.para -t G -GAL_LIB_IN LIB2020_FORS2_forFixedZ_CWW-E_v1 -GAL_LIB_OUT LIB2020_FORS2_forFixedZ_CWW-E_v1_noExt
...
echo "Estimation"
$LEPHAREDIR/source/zphota -c COSMOS2020.para -CAT_IN "$CAT_FILE_IN" -CAT_OUT zphot2020_fors2SL_FixedZ_CWW-E_v1_noExt.out -ZPHOTLIB LIB2020_FORS2_forFixedZ_CWW-E_v1_noExt,ALLSTAR_COSMOS2020,ALLQSO_COSMOS2020 -ZFIX YES -ADD_EMLINES 0,36 -AUTO_ADAPT YES -EM_DISPERSION 50,5 -INP_TYPE F
